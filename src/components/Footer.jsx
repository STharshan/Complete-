  ...
  return (
    <footer className="bg-black text-gray-300 py-12 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/CompleteFitnessgymsltd/" className="text-primary-hover transition">
              <FaFacebookF />
            </a>
            <a href="https://www.instagram.com/completefitnessgymnorwich/" className="text-primary-hover transition">
              <FaInstagram />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-start space-x-2">
              ...
              <span>
                2, Marriott Close, Heigham St, 
                <br />
                 Norwich NR2 4UX, United Kingdom
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="mt-10 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
        ...
        <span className="text-primary ">Complete Fitness LTD </span> | Powered by{" "}
